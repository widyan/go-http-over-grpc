...
import (
	...
	"github.com/widyan/go-http-over-grpc/modules/domain-grpc-test/handler"
	"github.com/widyan/go-http-over-grpc/modules/domain-grpc-test/repository"
	"github.com/widyan/go-http-over-grpc/modules/domain-grpc-test/usecase"
...
func Init(logger *logrus.Logger, grpcServer *grpc.Server, cfg config.Config, validator validate.ValidatorInterface, cfgRseponses responses.GinResponses) {
	...
	pb.RegisterTestServiceLagiServer(grpcServer, hndlr)
}
